...
\newcommand{\myTitle}{Handy\xspace}
\newcommand{\mySubtitle}{A Haskell-based Virtual Machine for the Execution of ARM Assembly Code\xspace}
\newcommand{\myDegree}{BA (Mod) in Computer Science\xspace}
\newcommand{\myName}{Miles McGuire\xspace}
\newcommand{\myProf}{Dr. David Abrahamson\xspace}
